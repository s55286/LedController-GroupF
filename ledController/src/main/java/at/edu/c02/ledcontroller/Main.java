...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (!input.equalsIgnoreCase("exit")) {
            ...
            System.out.println("Enter 'spinningwheel' to show a spinning wheel effect");
            ...
            if (input.equalsIgnoreCase("demo")) {
                ...
                System.out.println("Stating SpinningWheel effect...");
                ledController.spinningWheel(steps);
                System.out.println("Finished SpinningWheel effect...");
            }
        }
    }
}
